...
### Frontend (F)
- [x] Build audio upload component on Assistive Mode page
...
- [X] Wire "Test Transcription" button to POST /api/transcribe
- [X] Show transcript result in a text box below the upload area
- [X] Loading spinner + error state handling
